...
import sys
sys.path.append('/home/ollo/videomae-clean')
...
def train_model_interactive():
    ...
    torch.save(model.state_dict(), "videomae_finetuned_mixup.pth")
    print("Training complete. Model saved to 'videomae_finetuned_mixup.pth'.")
