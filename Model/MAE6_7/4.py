...
sys.path.append('/home/ollo/VideoMAE/')           # avion モジュールのルート
...
def main():
    ...
    torch.save(model.state_dict(), "avion_finetuned_with_pretrain_style.pth")
    print("Saved model to avion_finetuned_with_pretrain_style.pth")
