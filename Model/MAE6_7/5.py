...
def main():
    ...
    train_json = os.path.join(annotation_dir, "VideoMAE/videomae-clean/20250512_annotations_train.json")
    val_json = os.path.join(annotation_dir, "VideoMAE/videomae-clean/20250512_annotations_val.json")
    ...
    model = VisionTransformer(num_classes=58, use_flash_attn=False, drop_path_rate=0.2).to(device)
    ...
    torch.save(model.state_dict(), "avion_finetuned_with_schedule_aug.pth")
    print("Saved model to avion_finetuned_with_schedule_aug.pth")
